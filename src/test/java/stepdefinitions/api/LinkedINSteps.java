...
// Credential For Twitter
    ...
    public void user_post_a_message_on_linked_in() {
        ...
        String requestBody = "{\n" +
                ...
                "            \"shareCommentary\": {\n" +
                "                \"text\": \"Hello World! This is Third Post Automation on LinkedIn!\"\n" +
                "            },\n" +
...
//        twitter.setOAuthConsumer("0oULD2ByzI3tU7waYcSxiYqRj", "BViylHBOO6mGfFJyppiXjCWKWUKUPMqH6INrT3CrkKG0YiAutN");
//AccessToken accessToken = new AccessToken("1827199527708979201-edjjauqaoPs3reTIPM3ywNaDhHYj8c", "MmTFBYxzLscB0blZNlcQNjH1OPJWPWLFmALnkRutguH5D");
//        twitter.setOAuthAccessToken(accessToken);
//
//        try {
//                // Post a tweet
//                twitter.updateStatus("Hello Twitter! This is a tweet from Roshan.");
//            System.out.println("Roshan- Successfully posted the tweet!");
